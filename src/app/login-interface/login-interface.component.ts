...
export class LoginInterfaceComponent implements  OnInit {
  ...
  constructor(private service :EditingDataService,private fb : FormBuilder, private router : Router
    ,private authService:AuthService,private socialService: SocialAuthService) { }
  ...
  saveGoogleData() {
    // this.service.saveGoogleInfo(this.user.value).subscribe(response => {
    //   // Handle the response from the server here
    //   console.log('Response from server:', this.user.value);
